...
public class HashingSearch500000 {

    public static void main(String[] args) {
        String fileName = "C:/words.txt";
        HashMap<String, Integer> wordMap = new HashMap<>(500000);  //fast
        ...
        System.out.println("Average time taken over " + iterations + " iterations: " + averageNanoTime + " nanoseconds");
    }
}
